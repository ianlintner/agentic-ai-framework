 ...
 * @param inputType Input type name for serialization
 * @param outputType Output type name for serialization
 * @tparam I Input type
...
case class RemoteAgentRef[I, O](
   ...
   *
   * @return True if this agent is on a local server
   */
