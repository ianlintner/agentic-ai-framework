...
/** Query for discovering agents that match specific criteria.
  *
  * @param capabilities
  *   Set of capabilities that agents must have (empty for any)
  * @param inputType
  *   Optional required input type
  * @param outputType
  *   Optional required output type
  * @param properties
...
case class AgentQuery(
  ...
  /** Check if an agent matches this query.
    *
    * @param info
    *   The agent information to check against the query
    * @return
...
object AgentQuery:
  ...
  /** Create a query for discovering agents by capabilities.
    ...
    * @return
    *   Query for agents with the specified capabilities
    */
  ...
  /** Create a query for a specific agent by ID.
    *
    * @param agentId
    *   The agent ID to look for
    * @return
    *   Query for the specified agent
    */
  ...
  /** Create a query for agents with a specific input type.
    ...
    *   Maximum number of results
    * @return
    *   Query for agents with the specified input type
    */
  ...
  /** Create a query for agents with a specific output type.
    *
    * @param outputType
    *   The output type to match
    * @param limit
    *   Maximum number of results
    * @return
    *   Query for agents with the specified output type
    */
  ...
  /** Create a query for agents with specific property values.
    ...
    *   Maximum number of results
    * @return
    *   Query for agents with the specified properties
    */
