...
object DirectoryEvent {
   ...
   * @param info Complete information about the agent
   ...
   * @param timestamp When the metadata update occurred
   */
   ...
   *
   * @param agentId ID of the agent
   * @param oldLoadFactor Previous load factor (if any)
   * @param newLoadFactor New load factor
   * @param timestamp When the load factor change occurred
   */
