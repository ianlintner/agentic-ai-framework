...
/**
 * A simplified Stream trait for handling a stream of events.
 * This is intended to be a lightweight interface for event subscriptions.
 *
 * @tparam A The type of events in the stream
 */
trait Stream[A] {
  /**
