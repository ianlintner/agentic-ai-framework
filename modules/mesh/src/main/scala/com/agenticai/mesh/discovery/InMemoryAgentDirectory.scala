...
/** In-memory implementation of the AgentDirectory.
  *
  * This implementation is suitable for testing and small-scale deployments. It stores all agent
  * information in memory and provides simple event publishing.
  */
class InMemoryAgentDirectory extends AgentDirectory:
  ...
  private val eventListeners =
    new java.util.concurrent.CopyOnWriteArrayList[DirectoryEvent => Unit]()
