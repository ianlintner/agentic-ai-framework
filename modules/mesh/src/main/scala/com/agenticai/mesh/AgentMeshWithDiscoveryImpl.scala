...
/**
 * Implementation of AgentMeshWithDiscovery that combines an AgentMesh
 * with an AgentDirectory to provide capability-based discovery.
 *
 * @param mesh The underlying agent mesh
 * @param directory The agent directory for discovery
 */
private[mesh] class AgentMeshWithDiscoveryImpl(
   ...
   * Delegates to the underlying mesh.
   */
   ...
   * Returns a new instance with both mesh and directory.
   */
   ...
   * Combines deploying the agent via the mesh and registering its capabilities.
   */
   ...
   * Combines registering the agent in the mesh and its capabilities in the directory.
   */
