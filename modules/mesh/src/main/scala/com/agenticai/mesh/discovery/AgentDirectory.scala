...
/** Core interface for agent discovery in the mesh.
  *
  * The AgentDirectory provides mechanisms for registering agents, discovering agents based on
  * capabilities, and receiving notifications about agent availability changes.
  */
trait AgentDirectory:
  ...
  /** Register an agent with its capabilities and metadata.
    *
    * @param ref
    *   The reference to the agent being registered
    * @param metadata
    *   The agent's metadata including capabilities
    * @return
    *   Task that completes when registration is successful
    */
  ...
  /** Discover agents matching specific criteria.
    *
    * @param query
    *   The query specifying the search criteria
    * @return
    *   List of agent references that match the criteria
    */
