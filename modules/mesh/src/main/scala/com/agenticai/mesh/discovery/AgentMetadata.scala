...
/** Metadata about an agent's capabilities and characteristics.
  *
  * @param capabilities
  *   Set of capability identifiers that the agent provides
  * @param inputType
  *   Description of the agent's input type
  * @param outputType
  *   Description of the agent's output type
  * @param properties
...
/** Query for discovering agents using type constraints.
  *
  * @param capabilities
  *   Optional set of required capabilities
  * @param inputType
