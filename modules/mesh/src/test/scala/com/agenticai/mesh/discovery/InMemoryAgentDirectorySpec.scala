  ...
  def spec = suite("InMemoryAgentDirectory")(
    ...
    test("discoverAgents should filter by capabilities") {
      for
        ...
        textAgents <- directory.discoverAgents(
          TypedAgentQuery(
        ...
        mathAgents <- directory.discoverAgents(
          TypedAgentQuery(
        ...
        bothAgents <- directory.discoverAgents(
          TypedAgentQuery(
    ...
    test("updateAgentStatus should update status and publish events") {
      ...
      yield assert(initialStatus)(equalTo(AgentStatus.Active)) &&
    ...
    test("unregisterAgent should remove the agent") {
      ...
      yield assert(beforeUnregister.isDefined)(isTrue) &&
