 ...
 * This is a temporary implementation until we can properly configure ZIO HTTP
 */
object DashboardServer {
  ...
  def run: ZIO[Any, Throwable, ExitCode] = {
    for {
      ...
      _ <- Console.printLine("file:///Users/E74823/projects/agentic-ai-framework/modules/dashboard/src/main/resources/public/index.html")
