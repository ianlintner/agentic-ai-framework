...
/** Core data models for the task processing system. These models represent the request/response
  * flow for task processing and the intermediate data structures used during processing.
  */
