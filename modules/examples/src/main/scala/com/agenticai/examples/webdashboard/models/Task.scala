...
/** Core Task model representing a task in the agent system. This extends the basic TaskRequest
  * model with additional fields for tracking the task's progress and lifecycle.
  *
  * Following functional programming principles, all methods return a new Task instance rather than
...
case class Task(
  ...
  /** Calculate and return a new Task with updated progress based on subtask completion. This is a
    * pure function that does not modify the original Task.
    *
    * @return
    *   A new Task instance with updated progress and timestamp
    */
  def withUpdatedProgress: Task =
    val newProgress =
      if subtasks.isEmpty then if status == "Completed" then 1.0 else 0.0
      else {
  ...
  /** Return a new Task marked as started.
    *
    * @return
    *   A new Task instance with updated status and timestamps
    */
  def start: Task =
    this.copy(
      status = "InProgress",
  ...
  /** Return a new Task marked as completed with the given results.
    *
    * @param results
    *   The results to add to the completed task
    * @return
    *   A new Task instance marked as completed
    */
  ...
  /** Return a new Task with the given subtask added.
    ...
    *   The subtask to add
    * @return
    *   A new Task instance with the subtask added and progress updated
    */
  ...
  /** Return a new Task with multiple subtasks added.
    ...
    *   The subtasks to add
    * @return
    *   A new Task instance with the subtasks added and progress updated
    */
  ...
  /** Return a new Task with updated status for the specified subtask.
    ...
    * @param newStatus
    *   The new status for the subtask
    * @return
    *   A new Task instance with the updated subtask
    */
  def withUpdatedSubtaskStatus(subtaskId: String, newStatus: String): Task =
    val updatedSubtasks = subtasks.map { s =>
      if s.id == subtaskId then s.copy(status = newStatus) else s
    }
  ...
  /** Calculate the estimated time remaining for this task.
    *
    * @return
    *   An Option containing the estimated remaining time in milliseconds, or None if not applicable
    */
  ...
  /** Check if the task is overdue.
    *
    * @return
    *   True if the task has a deadline and is past it without being completed
    */
  ...
  /** Return a new Task with the given tag added.
    ...
    *   The tag to add
    * @return
    *   A new Task instance with the tag added
    */
  ...
  /** Return a new Task with the given metadata added or updated.
    ...
    *   The metadata value
    * @return
    *   A new Task instance with the updated metadata
    */
  ...
  /** Return a new Task with the given agent assignment.
    ...
    * @return
    *   A new Task instance with the agent assigned
    */
  ...
  /** Return a new Task with the given deadline.
    ...
    *   The deadline to set
    * @return
    *   A new Task instance with the deadline set
    */
  ...
  /** Create a Task for high-priority work.
    ...
    *   Optional deadline
    * @return
    *   A new high-priority Task instance
    */
...
object Task:
  ...
  /** Create a Task with pre-defined subtasks.
    ...
    *   The task description
    * @param subtasks
    *   The subtasks to include
    * @return
    *   A new Task instance with the specified subtasks
    */
