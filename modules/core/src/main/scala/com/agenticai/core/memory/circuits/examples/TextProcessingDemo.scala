...
/** Demonstrates the use of circuit patterns for text processing.
  *
  * This example shows how to compose agents using various combinators to build a text processing
  * pipeline inspired by Factorio's circuit networks.
  */
object TextProcessingDemo:

  // Set of common stop words to filter out
  val stopWords =
    Set("the", "a", "an", "and", "or", "but", "in", "on", "at", "to", "for", "with", "by")
  ...
  /** Alternative demo showing how to use a memory cell with a clock to process text at regular
    * intervals
    */
  def clockDemo(): Unit =
