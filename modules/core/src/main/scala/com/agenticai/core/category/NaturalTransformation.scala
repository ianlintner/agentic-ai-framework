...
/** Natural Transformation represents a conversion from one functor to another. It is a mapping
  * between functors that preserves the structure, meaning it commutes with the functors' map
  * operations.
  *
  * @tparam F
  *   Source functor
...
trait ~>[F[_], G[_]]:
  ...
  /** Compose this natural transformation with another.
    *
    * @param g
    *   Natural transformation from G to H
    * @return
    *   Natural transformation from F to H
    */
  ...
  /** Compose this natural transformation with another in reverse order.
    *
    * @param g
    *   Natural transformation from E to F
    * @return
    *   Natural transformation from E to G
    */
...
object `~>`:
  /** Identity natural transformation.
    *
    * @return
    *   Natural transformation that doesn't change the functor
    */
  ...
  /** Create a natural transformation from a function.
    *
    * @param f
    *   Function that preserves the structure
    * @return
