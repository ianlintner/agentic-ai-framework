...
trait Task[-I, +O] {
   ...
   * @return A new Task with mapped output
   */
   ...
   *
   * @param f Function from output to another Task
   * @return A new Task composing the operations
   */
   ...
   *
   * @param that Task to compose with
   * @return A new Task that processes both in parallel
   */
   ...
   *
   * @param that Task to compose with
   * @return A new Task representing the composition
   */
   ...
   * Convert to an Agent.
   *
   * @return An Agent representation of this task
   */
...
object Task {
   ...
   * @return A new Task that ignores its input
   */
   ...
   * @return A new Task that always fails
   */
   ...
   * @return A new Task that returns a list of results
   */
   ...
   * @return A new Task wrapping the agent
   */
   ...
   *
   * @param tasks The list of tasks to combine
   * @param f The function to combine results 
   * @return A new Task applying the combinator function to the results
   */
