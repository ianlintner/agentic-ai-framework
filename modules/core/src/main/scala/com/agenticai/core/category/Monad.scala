...
/**
 * Monad typeclass, extending Applicative with the ability to
 * flatten nested contexts via flatMap.
 */
trait Monad[F[_]] extends Applicative[F] {
   ...
   * @param f Function that returns a value in context F
   * @return Result of binding fa to f
   */
...
object Monad {
   ...
   * @param flatMapF Implementation of flatMap
