...
trait Capability[-I, +O]:
  ...
  /** Functorial map operation.
    ...
    * @return
    *   A new Capability with mapped output
    */
  ...
  /** Monadic flatMap operation.
    *
    * @param f
    *   Function from output to another Capability
    * @return
    *   A new Capability composing the operations
    */
  ...
  /** Compose with another capability.
    *
    * @param that
    *   Capability to compose with
    * @return
    *   A new Capability representing the composition
    */
  ...
  /** Parallel composition with another capability.
    ...
    *   Capability to compose with
    * @return
    *   A new Capability that processes both in parallel
    */
  ...
  /** Convert to a task.
    *
    * @return
    *   A Task representation of this capability
    */
  ...
  /** Convert to an agent.
    *
    * @return
    *   An Agent representation of this capability
    */
  ...
  /** Apply a condition to this capability.
    *
    * @param condition
    *   Condition to check on the input
    * @return
    *   A capability that returns an option based on the condition
    */
  ...
  /** Chain capabilities conditionally.
    ...
    * @return
    *   A capability that tries this first, then that if this fails
    */
  /** Chain capabilities conditionally.
    */
...
object Capability:
  ...
  /** Create a capability that succeeds with a constant value.
    ...
    * @return
    *   A new Capability that ignores its input
    */
  ...
  /** Create a capability that fails with the given error.
    ...
    * @return
    *   A new Capability that always fails
    */
  ...
  /** Combine multiple capabilities into one.
    *
    * @param capabilities
    *   The list of capabilities to combine
    * @return
    *   A new Capability that returns a list of results
    */
  ...
  /** Execute capabilities in parallel.
    *
    * @param capabilities
    *   The list of capabilities to execute in parallel
    * @return
    *   A new Capability that returns a list of results
    */
  ...
  /** Create a capability from a predicate.
    *
    * @param predicate
    *   Predicate to check on the input
    * @param error
    *   Error message if predicate fails
    * @return
    *   A capability that verifies the predicate
    */
  def fromPredicate[I](predicate: I => Boolean, error: String): Capability[I, I] =
    Capability(input =>
      if predicate(input) then ZIO.succeed(input)
...
/** Default implementation of Capability.
  ...
  *   Output type
  */
private final class DefaultCapability[-I, +O](f: I => ZIO[Any, Throwable, O])
    extends Capability[I, O]:
