...
class TextSplitterAgent extends Agent[String, String] {
   ...
   * @return Text with split sections
   */
  ...
  /**
   * Get the current delimiter configuration
...
object TextSplitterAgent {
   ...
   *
   * @return A new TextSplitterAgent instance
   */
   ...
   *
   * @return ZLayer that provides a TextSplitterAgent
   */
